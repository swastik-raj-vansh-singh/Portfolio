  ...
  return (
    <div className="w-full p-4 xl:px-12 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:gray-900 transition-colors duration-1000">
        <div className='w-full h-[50%] overflow-hidden rounded-lg'>
            <img 
                className='w-full h-60 object-cover group-hover:scale-110 during-300 cursor-pointer' 
                src={src} 
                alt="src"
            />
        </div>
        <div className='w-full mt-6 flex flex-col gap-6'>
            <div className='flex items-centern justify-between  '>
                ...
                <div className='flex gap-3'>
                    ...
                    <a href = "https://github.com/swastik-raj-vansh-singh?tab=repositories"> <BsGithub /> </a>
                    </span>
                    <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-designColor duration-300 cursor-pointer">
                     <FaGlobe /> 
                    </span>
